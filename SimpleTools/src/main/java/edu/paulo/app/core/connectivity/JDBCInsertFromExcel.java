...
public class JDBCInsertFromExcel {
	...
	public void setData(String strPathExcel, String strSheetName, String tableName)
	{
		...
		try {
			...
			exceptionString[1] = "setData(String strPathExcel, String strSheetName, String tableName) --- EXCEPTION LINE 52";
	...
	public void execData(Statement stment, Connection connects, ExcelReader eR,String tabName)
	{
	      ...
	      try {
			  ...
			  exceptionString[1] = "execData(Statement stment, Connection connects, ExcelReader eR,String tabName) --- EXCEPTION LINE 101";
	    	  stdb.exceptionStringz(exceptionString, e, cProp.getfException());
           try {
				connects.rollback();
	         ...
	         try {
				 ...
				 exceptionString[1] = "execData(Statement stment, Connection connects, ExcelReader eR,String tabName) --- EXCEPTION LINE 113";
				stdb.exceptionStringz(exceptionString, e, cProp.getfException());
			}  
	      }
