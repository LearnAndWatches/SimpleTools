...
public class JDBCInsertFromCSVDiffStyle {
	...
	public JDBCInsertFromCSVDiffStyle(String strPathCSV, String tableName)
	{
		stdb = new SimpleToolsDB();
		exceptionString[0] = "JDBCInsertFromCSVDiffStyle";
	...
	public void setData(String strPathCSV, String tableName)
	{
		...
		try {
		    ...
		    execData(stmt, conn, csvReader,tableName);
        	 ...
        	 exceptionString[1] = "setData(String strPathCSV, String tableName) -- EXCEPTION LINE 47";
...
//		  exceptionString[1] = "execData(Statement stment, Connection connects, CSVScanner csvR,String tabName)";
	      try {
	    	  ...
	    	  exceptionString[1] = "execData(Statement stment, Connection connects, CSVScanner csvR,String tabName) -- EXCEPTION LINE 108";
	    	  stdb.exceptionStringz(exceptionString, e, cProp.getfException());
           try {
				connects.rollback();
			} catch (Exception e1) {
				exceptionString[1] = "execData(Statement stment, Connection connects, CSVScanner csvR,String tabName) -- EXCEPTION LINE 113";
	         ...
	         try {
				...
				exceptionString[1] = "execData(Statement stment, Connection connects, CSVScanner csvR,String tabName) -- EXCEPTION LINE 120";
				stdb.exceptionStringz(exceptionString, e, cProp.getfException());
			}  
	      }
